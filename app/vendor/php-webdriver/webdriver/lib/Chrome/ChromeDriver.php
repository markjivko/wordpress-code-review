...
class ChromeDriver extends LocalWebDriver {
     ...
     *
     * @xtodo Remove $service parameter. Use `ChromeDriver::startUsingDriverService` to pass custom $service instance.
     * @return static
     */
    ...
    /**
     * @xtodo Remove in next major version. The class is internally no longer used and is kept only to keep BC.
