...
class DesiredCapabilities implements WebDriverCapabilities {
    ...
    /**
     * @xtodo Remove in next major release (BC)
    ...
    /**
     * @xtodo Remove side-effects - not change eg. ChromeOptions::CAPABILITY from instance of ChromeOptions to an array
     * @return array
     */
    public function toArray() {
        if (isset($this->capabilities[ChromeOptions::CAPABILITY]) &&
            ...
            $this->capabilities[ChromeOptions::CAPABILITY] = $this->capabilities[ChromeOptions::CAPABILITY]->toArray();
        }
        ...
        if (isset($this->capabilities[FirefoxOptions::CAPABILITY]) &&
            ...
            $this->capabilities[FirefoxOptions::CAPABILITY] = $this->capabilities[FirefoxOptions::CAPABILITY]->toArray();
        }

        if (isset($this->capabilities[FirefoxDriver::PROFILE]) &&
            $this->capabilities[FirefoxDriver::PROFILE] instanceof FirefoxProfile
        ) {
            $this->capabilities[FirefoxDriver::PROFILE] = $this->capabilities[FirefoxDriver::PROFILE]->encode();
        }
    ...
    public function toW3cCompatibleArray() {
        ...
        if (array_key_exists(FirefoxDriver::PROFILE, $ossCapabilities)) {
            ...
            if (!array_key_exists(FirefoxOptions::CAPABILITY, $ossCapabilities) || !array_key_exists('profile', $ossCapabilities[FirefoxOptions::CAPABILITY])) {
    ...
    private function get($key, $default = null) {
        return isset($this->capabilities[$key]) ? $this->capabilities[$key] : $default;
    }
